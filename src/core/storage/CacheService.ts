...
export class CacheService {
	...
	private constructApiConfigurationFromCache(): ApiConfiguration {
		return {
			...
			planModeSapAiCoreDeploymentId: this.globalStateCache.get("planModeSapAiCoreDeploymentId"),
			...
			actModeSapAiCoreDeploymentId: this.globalStateCache.get("actModeSapAiCoreDeploymentId"),
