...
export function convertApiConfigurationToProto(config: ApiConfiguration): ProtoApiConfiguration {
	return {
		...
		planModeSapAiCoreOrchestrationDeploymentId: config.planModeSapAiCoreOrchestrationDeploymentId,
		...
		actModeSapAiCoreOrchestrationDeploymentId: config.actModeSapAiCoreOrchestrationDeploymentId,
...
export function convertProtoToApiConfiguration(protoConfig: ProtoApiConfiguration): ApiConfiguration {
	return {
		...
		planModeSapAiCoreOrchestrationDeploymentId: protoConfig.planModeSapAiCoreOrchestrationDeploymentId,
		...
		actModeSapAiCoreOrchestrationDeploymentId: protoConfig.actModeSapAiCoreOrchestrationDeploymentId,
